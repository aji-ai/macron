...
function useJobs() {
  ...
  const saveJob = reactExports.useCallback(
    async (job) => {
  ...
  const deleteJob = reactExports.useCallback(
    async (id) => {
      ...
      return (
        ...
        (() => {
          var __webpack_modules__ = {
            /***/
            949(__unused_webpack_module, exports$12, __webpack_require__2) {
              Object.defineProperty(exports$12, "__esModule", { value: true });
              exports$12.CronParser = void 0;
              ...
              exports$12.CronParser = CronParser;
            },
            /***/
            333(__unused_webpack_module, exports$12, __webpack_require__2) {
              Object.defineProperty(exports$12, "__esModule", { value: true });
              exports$12.ExpressionDescriptor = void 0;
              ...
              var ExpressionDescriptor = (function() {
                ...
                ExpressionDescriptor2.prototype.getHoursDescription = function() {
                  ...
                  var description = this.getSegmentDescription(expression, this.i18n.everyHour(), function(s) {
                    var match = rangeEndValues.find(function(r2) {
                      return r2.value === s && r2.index === evaluationIndex;
                    });
              ...
              exports$12.ExpressionDescriptor = ExpressionDescriptor;
            },
            /***/
            747(__unused_webpack_module, exports$12, __webpack_require__2) {
              Object.defineProperty(exports$12, "__esModule", { value: true });
              exports$12.enLocaleLoader = void 0;
              ...
              exports$12.enLocaleLoader = enLocaleLoader;
            },
            /***/
            486(__unused_webpack_module, exports$12) {
              Object.defineProperty(exports$12, "__esModule", { value: true });
              exports$12.en = void 0;
              var en = (function() {
                function en2() {
                }
            ...
            /***/
            515(__unused_webpack_module, exports$12) {
              Object.defineProperty(exports$12, "__esModule", { value: true });
              ...
              exports$12["default"] = RangeValidator;
            },
            /***/
            823(__unused_webpack_module, exports$12) {
              Object.defineProperty(exports$12, "__esModule", { value: true });
              exports$12.StringUtilities = void 0;
              ...
              exports$12.StringUtilities = StringUtilities;
            }
            /******/
          };
...
function parseNLSchedule(input) {
...
function getNextRunTime(schedule) {
  ...
  const test = new Date(now.getTime() + 6e4);
  test.setSeconds(0, 0);
  const limit = new Date(now.getTime() + 366 * 24 * 60 * 60 * 1e3);
  while (test < limit) {
    if (matches(monField, test.getMonth() + 1) && matches(domField, test.getDate()) && matches(dowField, test.getDay()) && matches(hourField, test.getHours()) && matches(minField, test.getMinutes())) {
      return formatRelative(test, now);
    }
    test.setTime(test.getTime() + 6e4);
  }
...
function JobList({ jobs, selectedId, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-0.5 p-2", children: jobs.map((job) => {
    const isSelected = job.id === selectedId;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => onSelect(job.id),
        className: `w-full text-left px-3 py-2.5 rounded-lg transition-all duration-100 ${isSelected ? "bg-white/70 shadow-sm ring-1 ring-black/5" : "hover:bg-white/40"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm text-foreground truncate leading-snug", children: job.name || "Unnamed Job" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5 truncate", children: cronToHuman(job.schedule) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground/60 mt-0.5", children: getNextRunTime(job.schedule) })
        ]
      },
      job.id
    );
...
function Sidebar({ jobs, loading, selectedId, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-[220px] flex-shrink-0 flex flex-col h-full sidebar-vibrancy border-r border-black/[0.06]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "traffic-light-spacer" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-2 drag-region", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xs font-semibold text-foreground/50 tracking-widest uppercase", children: "Macron" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 min-h-0", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-sm text-muted-foreground", children: "Loading…" }) : jobs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-sm text-muted-foreground", children: "No jobs yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(JobList, { jobs, selectedId, onSelect }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-t border-black/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        variant: "outline",
        size: "sm",
...
function fieldsToExpr(f) {
  return `${f.min} ${f.hour} ${f.dom} ${f.month} ${f.dow}`;
}
function SchedulePicker({ value, onChange }) {
  const [tab, setTab] = reactExports.useState("presets");
  const [nlInput, setNlInput] = reactExports.useState("");
  const [nlError, setNlError] = reactExports.useState("");
  const [rawFields, setRawFields] = reactExports.useState(() => parseCronFields(value));
  reactExports.useEffect(() => {
    setRawFields(parseCronFields(value));
  }, [value]);
  function handleNlChange(input) {
    setNlInput(input);
    if (!input.trim()) {
      setNlError("");
      return;
  ...
  function handleRawField(field, val) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 p-1 bg-muted rounded-md w-fit text-xs", children: ["presets", "natural", "raw"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setTab(t),
        className: `px-3 py-1 rounded font-medium transition-colors ${tab === t ? "bg-background shadow-sm text-foreground" : "text-muted-foreground hover:text-foreground"}`,
        children: tabLabels[t]
      },
      t
    )) }),
    tab === "presets" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: SCHEDULE_PRESETS.map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => onChange(preset.value),
        className: `text-left p-2.5 rounded-md border text-sm transition-all ${value === preset.value ? "border-primary bg-primary/5 text-primary" : "border-border hover:border-primary/40 hover:bg-muted/50"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-xs", children: preset.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: preset.description })
        ]
      },
      preset.value
    )) }),
    tab === "natural" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          value: nlInput,
      ...
      nlError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: nlError }),
      !nlError && nlInput && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "Parsed to: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono", children: value })
      ] })
    ] }),
    tab === "raw" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 gap-2", children: [
      ["min", "Min"],
      ["hour", "Hour"],
      ["dom", "Day"],
      ["month", "Mon"],
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs text-muted-foreground block text-center", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
    ...
    humanReadable && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "font-mono text-xs", children: value }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: humanReadable })
    ] })
  ] });
}
function Dialog({
...
function ConfirmDialog({ open, title, description, onConfirm, onCancel }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onCancel(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-[380px]", children: [
...
function JobEditor({ job, onSave, onDelete, onSelect }) {
  const [name, setName] = reactExports.useState("");
  const [command, setCommand] = reactExports.useState("");
  const [schedule, setSchedule] = reactExports.useState("0 9 * * *");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-border/50 drag-region", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-sm", children: isNew ? "New Job" : "Edit Job" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: handleSave, disabled: saving || !command.trim(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "w-4 h-4 mr-2" }),
          saving ? "Saving…" : "Save"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-auto px-6 py-5 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "Schedule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SchedulePicker, { value: schedule, onChange: setSchedule })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConfirmDialog,
...
function EmptyState({ onNewJob }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-4 text-muted-foreground select-none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-12 h-12 opacity-20" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground", children: "No job selected" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Automate your agent tasks with cron jobs" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: onNewJob, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 mr-2" }),
      "New Job"
    ] })
  ] });
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen overflow-hidden bg-transparent", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sidebar,
      {
        jobs,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-hidden bg-background/80 backdrop-blur-sm", children: selectedId !== null ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      JobEditor,
      {
        job: selectedJob,
        onSave: saveJob,
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { onNewJob: () => setSelectedId("new") }) })
  ] });
}
